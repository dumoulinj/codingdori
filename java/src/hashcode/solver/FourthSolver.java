...
public class FourthSolver implements Solver {
		...
		do{
			...
			cachesTemp.sort(new Comparator<Cache>() {
				...
				public int compare(Cache o1, Cache o2) {
					//return o2.getMaxScore(true) - o1.getMaxScore(true);
					
					if(o1.getEndpoints().size() == o2.getEndpoints().size()){
					...
					return o2.getEndpoints().size() - o1.getEndpoints().size();
				}
			});
